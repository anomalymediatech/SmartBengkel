                ...
                <?php
                  if(mysqli_num_rows($result) > 0){
                    ...
                    while($row = mysqli_fetch_array($result)){
                      ...
                      echo '<a href="trx_detail_v2.php?id=' . htmlspecialchars($row['id_trx']) .'" class="btn btn-info btn-xs" title="Lihat Detail"><i class="fa fa-eye"></i> Detail</a> ';
                      echo '<a href="struk_thermal.php?id=' . htmlspecialchars($row['id_trx']) .'" class="btn btn-default btn-xs" title="Cetak Struk"><i class="fa fa-print"></i> Cetak</a>';
                      echo '</td>';
                      echo '</tr>';
                      $i++;
                    }
