...
if(isset($_POST['simpan'])){
    ...
    $sqltmp = "UPDATE tmp_trx SET id_trx='$no', status='$stt' WHERE id_kasir='$kasir' AND status='$stts'";
    mysqli_query($conn, $sqltmp);

    // Insert into trx table
    $sqltrx = "INSERT INTO trx (id_trx, id_kon, tgl_trx, total, id_kasir, metode_bayar, diskon_nota, status_bayar, jatuh_tempo, plat_nomor, catatan)
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="tabel-data">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    $grand = 0;
                                    $sql = "SELECT tmp_trx.*, barangjasa.*, kasir.* FROM tmp_trx, barangjasa, kasir
                                            WHERE tmp_trx.id_brg=barangjasa.id_brg AND tmp_trx.id_kasir=kasir.id_kasir
                                            AND tmp_trx.status='On Process' AND tmp_trx.id_kasir='$kasir'
                                    ...
                                    while($data = mysqli_fetch_array($ress)){
                                        ...
                                        echo '<td class="text-center">'; ?>
                                            <a href="trxtmp_hapus.php?id=<?php echo $data['id_tmp']; ?>"
                                               onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $data['nama']; ?>?');"
                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" name="metode_bayar" value="<?php echo isset($_POST['metode_bayar']) ? $_POST['metode_bayar'] : 'Tunai'; ?>">
                            <input type="hidden" name="diskon_nota" value="<?php echo isset($_POST['diskon_nota']) ? $_POST['diskon_nota'] : '0'; ?>">
                        </div>
